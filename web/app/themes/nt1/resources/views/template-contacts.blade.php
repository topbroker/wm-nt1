      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 lg:gap-150px mb-60px">
          <div class="flex">
              ...
              <div class="font-light ml-30px space-y-6">
                  <div class="text-24px font-bold uppercase">Kontaktai</div>
                  <div>+370 673 58 312</div>
                  <div>info@crew.lt</div>
              </div>
          </div>
          <div class="flex">
              <div class="flex-none pt-2">
              ...
              <div class="font-light ml-30px space-y-6">
                  <div class="text-24px font-bold uppercase">Adresas</div>
                  <div>Quadrum East, 6 aukštas</div>
                  <div>Konstitucijos pr. 21a, Vilnius</div>
              </div>
          </div>
          <div class="flex">
              <div class="flex-none pt-2">
              ...
              <div class="font-light ml-30px space-y-6">
                  <div class="text-24px font-bold uppercase">Rekvizitai</div>
                  <div>Pavadinimas</div>
                  <div>įm. kodas 1234568974552</div>
                  <div>Banko sąskaita</div>
              </div>
          </div>
      </div>
      <div class="shadow-custom-1 bg-white p-30px pb-70px flex flex-col lg:flex-row items-center lg:space-x-60px">
          <div class="block lg:hidden text-20px uppercase mb-6">Registruokitės konsultacijai</div>
          ...
          <div class="w-full lg:w-auto flex-1">
              <div class="hidden lg:block text-24px uppercase mb-4">Registruokitės konsultacijai</div>
              <label>
                  <span class="uppercase block font-light mb-1">pastabos</span>
              ...
              <div class="flex justify-between mt-6">
                  <label class="w-full max-w-300px text-12px flex">
                      ...
                      <span class="ml-2">
                          Sutinku, kad mano duomenys būtų išsaugoti. Daugiau informacijos: <a href="{{ get_privacy_policy_url() }}" target="_blank" class="text-red-1">privatumo politika</a>
                      </span>
                  </label>
