...
@if($section_image_id)
    <div class="section-hero bg-cover bg-center" style="background-image:url({{ wp_get_attachment_image_url($section_image_id, 'xlarge') }})">
@else
    <div class="section-hero bg-cover bg-center" style="background-image:url(@asset('images/daniel-dinuzzo-qCjolcMFaLI-unsplash.jpg'))">
@endif
